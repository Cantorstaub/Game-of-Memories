...
The _Game of Memories_ was designed to study the inner workings of an older computer with much less complexity compared to modern devices. Working in Assembler on an emulated machine provided the possibility to peek into the emulated machine, in our case, into its memory, to scrutinize elementary functionalities down to the single bit, and to take up on mediatheoretical thoughts and conclusions hands-on. In particular, an understanding of the connections between the different strata of computer processes delevoped and of how _real_ states – to reference the methodological trias of Friedrich A. Kittler – are related to _symbolic_ signs within the machine. This opened up avenues to rethink the mediatheoretical stance on programming and processing of digital machines as forms of _writing_.
...
_Figure 5. WinArcadia made it possible to switch between two different modes for the visualisation of the content of the memory. Using the hexadecimal values 17 and 15 createed the impression of empty and filled cells, as it is standard for most cellular automata._
