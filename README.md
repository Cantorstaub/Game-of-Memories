...
<img src = "/Pictures/GRAFIK_GoM_Speicherfläche mit Okatgon_2.JPG?raw=true" width = "500" title = "The emulator provides us with a graphical representation of the memory bank of the emulated machine where the Game of Memory is playing, here showing an octagon." alt = "A 16 x 16 field of squares coloured in light green. Above the upper column an index is visible froom 0 to F. On the left side the rows are indexed from $0E0x: $ to $0EFx: $. Some squares contain little black circels, together forming an octagon."/>

_The emulator provides us with a graphical representation of the memory bank of the emulated machine where the Game of Memory is playing, here showing an octagon._
